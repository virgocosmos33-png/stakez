...
// initial board (padded top and bottom): 4 visible rows + 2 padding = 6 entries per reel
export const INITIAL_BOARD: RawSymbol[][] = [
	[{ name: 'L2' }, { name: 'L1' }, { name: 'L4' }, { name: 'H2' }, { name: 'L1' }, { name: 'L3' }],
	[{ name: 'H1' }, { name: 'L5' }, { name: 'L2' }, { name: 'H3' }, { name: 'L4' }, { name: 'L2' }],
	[{ name: 'L3' }, { name: 'L5' }, { name: 'L3' }, { name: 'H4' }, { name: 'L4' }, { name: 'L5' }],
	[{ name: 'H4' }, { name: 'H3' }, { name: 'L4' }, { name: 'L5' }, { name: 'L1' }, { name: 'L4' }],
	[{ name: 'H3' }, { name: 'L3' }, { name: 'L3' }, { name: 'H1' }, { name: 'H1' }, { name: 'L2' }],
];
